...
common::hash_t TupleUpdatePlanNode::Hash() const {
...
bool TupleUpdatePlanNode::operator==(const AbstractPlanNode &rhs) const {
...
nlohmann::json TupleUpdatePlanNode::ToJson() const {
...
std::vector<std::unique_ptr<parser::AbstractExpression>> TupleUpdatePlanNode::FromJson(const nlohmann::json &j) {
...
DEFINE_JSON_BODY_DECLARATIONS(TupleUpdatePlanNode);
