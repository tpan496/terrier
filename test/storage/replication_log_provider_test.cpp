...
class ReplicationLogProviderTests : public TerrierTest {
 protected:
...
// NOLINTNEXTLINE
TEST_F(ReplicationLogProviderTests, ReplicationLogProviderTest) {
...
// NOLINTNEXTLINE
TEST_F(ReplicationLogProviderTests, ConcurrentReplicationLogProviderTest) {
